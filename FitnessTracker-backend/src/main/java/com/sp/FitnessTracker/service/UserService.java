...
public class UserService {
    ...
    public ResponseEntity<AuthResponse> login(LoginRequest authRequest) throws Exception {
        ...
        System.out
                .println("Password Matches? " + passwordEncoder.matches(authRequest.getPassword(), user.getPassword()));
    ...
    public void share(ShareRequest shareRequest, String token) throws AccessDeniedException {
        ...
        notification
                .setMessage("You have a new shared activity from " + sender.getUsername() + ": " + activity.getType());
